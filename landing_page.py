...
.hero{
    min-height:92vh;background:#03070f;
...
.hero-grid{
    position:absolute;inset:0;
    background-image:linear-gradient(#0d213720 1px,transparent 1px),
...
.eyebrow-dot{
    ...
    background:#00c2ff;box-shadow:0 0 8px #00c2ff;
...
.stat-bar{
    display:flex;gap:0;border:1px solid #0d2137;
    border-radius:14px;overflow:hidden;
    background:#060c16;width:fit-content;margin-top:8px;
}
...
.s-label{font-family:'JetBrains Mono',monospace;font-size:.6rem;
    color:#00c2ff;text-transform:uppercase;letter-spacing:.22em;margin-bottom:10px;}
.s-h2{font-family:'Bebas Neue',sans-serif;font-size:2.6rem;
    color:#e8f4ff;letter-spacing:.04em;margin:0 0 6px;}
.s-desc{font-size:.9rem;color:#3a5a7a;line-height:1.75;
    max-width:620px;font-weight:300;}

.mod-grid{display:grid;grid-template-columns:repeat(3,1fr);
    gap:1px;background:#0d2137;border-radius:16px;overflow:hidden;margin-top:36px;}
.mod-card{
...
.diff-wrap{margin-top:28px;border:1px solid #0d2137;
    border-radius:14px;overflow:hidden;}
...
.cta-section{
    ...
    background:radial-gradient(ellipse 50% 80% at 50% 100%,#00152200,#03070f 60%);
...
""")
    ...
    #  HERO 
    _html("""<div class="hero">
  <div class="hero-bg"></div>
  <div class="hero-grid"></div>
  <div class="hero-content">
    <div class="hero-eyebrow">
      <span class="eyebrow-dot"></span>
      Blostem AI Builder Hackathon 2026 &#160;&middot;&#160; Track 03 &#160;&middot;&#160; Solo Build
    </div>
    <h1 class="hero-title">
      FD Funnel<br><span class="accent">Intelligence</span><br>Engine
    </h1>
    <p class="hero-sub">
  ...
  <p class="s-desc">From raw event logs to a ranked list of users to contact today &mdash; end to end, no manual steps.</p>
  <div class="mod-grid">
    <div class="mod-card" style="--accent:#00c2ff">
      <div class="mod-num">01</div> 
      <div class="mod-title">Funnel Analytics</div>
      <div class="mod-desc">Event-driven funnel with stage-by-stage drop-off rates, SHAP-ranked drivers, device and tier breakdowns.</div>
    </div>
    ...
    <div class="mod-card" style="--accent:#4ade80">
      ...
      <div class="mod-desc">KMeans k=4 behavioural clustering with 0&ndash;63% conversion spread + NVIDIA Llama-3.3-70B plain-English briefs.</div>
    </div>
    <div class="mod-card" style="--accent:#f472b6">
      <div class="mod-num">05</div> 
      <div class="mod-title">Priority Queue</div>
      <div class="mod-desc">Batch decision engine ranking every user by net intervention ROI &mdash; highest revenue recovery per &#8377; spent first.</div>
    </div>
    <div class="mod-card" style="--accent:#00c2ff">
    ...
    #  MODEL SCORES 
    _html("""<div class="section section-alt">
  <div class="s-label">Live Training Results</div>
  <h2 class="s-h2">Numbers from the actual run.</h2>
  <p class="s-desc">Trained on 2,000 synthetic users modelled on real FD funnel behaviour. Drop-off F1 uses 17 leak-free features &mdash; no data leakage.</p>
  <div class="score-grid">
    <div class="score-card" style="--c:#00c2ff">
      ...
      <div class="score-note">calibrated &middot; raw: 0.9392</div>
    </div>
    ...
    <div class="score-card" style="--c:#a78bfa">
      ...
      <div class="score-note">XGBoost &middot; acc: 0.7310</div>
    </div>
    <div class="score-card" style="--c:#fbbf24">
      ...
      <div class="score-note">High-Value Converters &middot; 346 users</div>
    </div>
  </div>
</div>""")
  ...
  <p class="s-desc">Every component chosen for a specific reason. 30+ features, 5 models, 6 tabs, zero copy-paste.</p>
  <div class="stack-grid">
    <div class="stack-pill" style="--c:#00c2ff">
      <div class="pill-name">LightGBM + Platt Calibration</div>
      <div class="pill-desc">400 estimators, scale_pos_weight for imbalance, sigmoid-calibrated probabilities for accurate &#8377; ROI</div>
    </div>
    <div class="stack-pill" style="--c:#a78bfa">
      <div class="pill-name">XGBoost Drop-off Model</div>
      <div class="pill-desc">17 leak-free features, multiclass, weighted F1 0.729 &mdash; leakage identified and removed</div>
    </div>
    <div class="stack-pill" style="--c:#4ade80">
      <div class="pill-name">SHAP TreeExplainer</div>
      <div class="pill-desc">Per-prediction waterfall + global importance &mdash; explains why, not just what</div>
    </div>
    <div class="stack-pill" style="--c:#fbbf24">
      <div class="pill-name">KMeans k=4 Segmentation</div>
      <div class="pill-desc">10 StandardScaled behavioural features &middot; 0% to 63% conversion spread across clusters</div>
    </div>
    <div class="stack-pill" style="--c:#f472b6">
      <div class="pill-name">NVIDIA Llama-3.3-70B</div>
      <div class="pill-desc">Structured insights via NIM API &mdash; segment briefs, intervention narratives, exec summaries</div>
    </div>
    <div class="stack-pill" style="--c:#00c2ff">
      <div class="pill-name">30+ Engineered Features</div>
      <div class="pill-desc">Behavioural &middot; temporal &middot; KYC friction &middot; device switching &middot; interaction terms</div>
    </div>
  </div>
</div>""")
  ...
  <div class="diff-wrap">
    <table class="diff-table">
      <tr>
        <th>Existing Tool</th><th></th><th>What They Do</th><th></th><th>What We Do Instead</th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="td-arrow">&rarr;</td>
        <td class="td-us">Live per-user prediction + SHAP waterfall in under 1s</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="td-arrow">&rarr;</td>
        <td class="td-us">Ranked queue &mdash; who to call, what to say, ROI per &#8377;</td>
      </tr>
    </table>
  </div>
</div>""")
  ...
  <p class="s-desc" style="max-width:700px">
    Blostem connects 30+ fintech platforms to 10+ banks. Every FD booking that drops at KYC
    or Details is direct revenue lost. This engine gives product and growth teams one interface:
    understand the funnel, predict failures, simulate fixes, act.
  </p>
  <div class="purpose-strip">
    <div class="purpose-item" style="--c:#ff4d5a">
      <div class="purpose-kicker" style="color:#ff4d5a">The Problem</div>
      <div class="purpose-text">FD funnel drop-off is invisible until it is already too late. Teams react instead of preventing.</div>
    </div>
    <div class="purpose-item" style="--c:#00c2ff">
      <div class="purpose-kicker">The System</div>
      <div class="purpose-text">Predict drop-off probability, explain with SHAP, simulate interventions, rank by ROI &mdash; automated.</div>
    </div>
    ...
    #  CTA 
    _html("""<div class="cta-section">
  <div class="cta-h">See It Live.</div>
  <div class="cta-sub">AUC 0.9425 &#160;&middot;&#160; F1 0.7432 &#160;&middot;&#160; Drop-off F1 0.7290 &#160;&middot;&#160; 30 features &#160;&middot;&#160; 6 tabs</div>
</div>""")

    _html("""<style>
div[data-testid="stButton"] > button[kind="primary"] {
    background: linear-gradient(135deg, #0047ab 0%, #0066cc 60%, #0080ff 100%) !important;
    ...
    box-shadow: 0 0 32px #0066cc30, 0 4px 16px #00000040 !important;
    transition: all .25s !important;
}
div[data-testid="stButton"] > button[kind="primary"]:hover {
    background: linear-gradient(135deg, #0055cc 0%, #0077ee 60%, #1a99ff 100%) !important;
    border-color: #0080ff !important;
    box-shadow: 0 0 48px #0080ff50, 0 6px 24px #00000050 !important;
